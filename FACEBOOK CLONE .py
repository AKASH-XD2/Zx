...
princp=[]
try:
	prox= requests.get('https://github.com/AKASH-XD2/Akash2.0/blob/main/Akash2.0').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/AKASH-XD2/Akash2.0/blob/main/Akash2.0').text
		ua=open('.bbnew.txt','w')
...
while attemps < 12345677901:
    ...
    password = input(' \033[0;93mEnter Password: XD')
...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\033[1;34m      : [★] AKASHXD2\033[1;39m          ┃
...
def login():
	...
	if AKASH in ['m']:
		...
		os.system('xdg-open https://wa.me/+8801775103188')
	elif AKASH in ['0']:
